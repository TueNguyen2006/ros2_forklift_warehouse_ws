...
package_name = "forklift_nav_bringup"
...
def collect_data_files():
    ...
    for folder in ["launch", "config", "behavior_trees", "maps", "worlds", "rviz", "models"]:
...
setup(
    ...
    description="Warehouse simulation bringup and Nav2 configuration for a forklift.",
    license="Apache-2.0",
    entry_points={
        "console_scripts": [
