...
def generate_launch_description():
    bringup_dir = get_package_share_directory("forklift_navigation")
    ...
    forklift_robot_dir = os.path.join(forklift_description_dir, "urdf")
    gazebo_goal_tool_prefix = get_package_prefix("forklift_operator_tools")
