...
setup(
    ...
    scripts=[
        ...
        "scripts/canonical_safety_monitor.py",
        "scripts/canonical_trajectory_monitor.py",
        "scripts/canonical_command_filter.py",
        "scripts/canonical_human_distance_source.py",
        "scripts/canonical_benchmark_logger.py",
    ],
    zip_safe=True,
    maintainer="Codex",
