    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                default_value=os.path.join(navigation_dir, "config", "collision_monitor.yaml"),
            ),
            DeclareLaunchArgument(
                "map",
            ...
            DeclareLaunchArgument(
                "keepout_mask",
                default_value=os.path.join(navigation_dir, "maps", "warehouse_keepout_mask.yaml"),
            ),
            DeclareLaunchArgument(
                "speed_mask",
                default_value=os.path.join(navigation_dir, "maps", "warehouse_speed_mask.yaml"),
            ),
            DeclareLaunchArgument(
                "profile_config",
